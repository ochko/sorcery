        ...
        class << self
          ...
          def init_orm_hooks!
            self.class_eval do
              ...
              attr_protected @sorcery_config.crypted_password_attribute_name, @sorcery_config.salt_attribute_name unless defined?(ActiveModel::DeprecatedMassAssignmentSecurity)
